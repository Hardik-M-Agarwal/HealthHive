        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="px-6 py-6">
          ...
          <div className="space-y-4">
            ...
            <input
              type="hidden"
              {...register('unit')}
              value={vitalsTypes.find(t => t.value === vitalsType)?.unit}
            />
          ...
          <div className="mt-6 flex justify-end space-x-3">
            ...
            <button
              type="submit"
              className="px-6 py-2 bg-gradient-to-r from-green-600 to-emerald-500 text-white rounded-lg hover:shadow-lg"
            >
              Save Reading
            </button>
