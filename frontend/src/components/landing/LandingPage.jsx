    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center space-x-3">
              <div className="relative">
                <div className="w-10 h-10 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-xl flex items-center justify-center transform rotate-3 hover:rotate-0 transition-transform duration-300">
            ...
            <div className="flex items-center space-x-4">
              {!isAuthenticated ? (
                <>
                  <Link
                    to="/login"
                    className="px-5 py-2 text-gray-700 hover:text-blue-600 font-medium transition-colors relative group"
                  >
                    Login
                  ...
                  <Link
                    to="/signup"
                    className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-medium rounded-xl hover:shadow-lg hover:shadow-blue-500/25 transform hover:scale-105 transition-all duration-300"
                  >
                    Sign Up Free
                  </Link>
                </>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            {/* Description */}
            <p className="max-w-2xl mx-auto text-xl text-gray-600 mb-10 animate-slide-up animation-delay-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-slide-up animation-delay-400">
              <Link
                to="/signup"
                className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-blue-500/30 transform hover:scale-105 transition-all duration-300"
              >
              ...
              <a
                href="#features"
                className="px-8 py-4 bg-white text-gray-700 font-semibold rounded-xl border-2 border-gray-200 hover:border-blue-500 hover:text-blue-600 transform hover:scale-105 transition-all duration-300"
              >
                Watch Demo
              </a>
            </div>
          ...
          <div className="mt-20 relative animate-float">
            <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-3xl blur-2xl opacity-20"></div>
            ...
            {/* Floating Elements */}
            <div className="absolute -top-4 -right-4 w-20 h-20 bg-green-400 rounded-full flex items-center justify-center animate-bounce">
              <span className="text-white font-bold text-2xl">24/7</span>
            </div>
            <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-purple-400 rounded-full flex items-center justify-center animate-pulse">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              ...
              <span className="block text-blue-600">Manage Family Health</span>
            </h2>
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className={`w-16 h-16 bg-gradient-to-r ${feature.color} rounded-xl flex items-center justify-center text-white flex-shrink-0`}>
                      {feature.icon}
                    </div>
                    <div>
                  ...
                  <div className="p-6 text-white">
                    ...
                    {activeFeature === 0 && (
                      <div className="space-y-4 animate-fade-in">
                        <div className="h-4 w-3/4 bg-blue-400/30 rounded"></div>
                        <div className="h-4 w-1/2 bg-blue-400/30 rounded"></div>
                        <div className="grid grid-cols-2 gap-4 mt-6">
                          ...
                          <div className="p-3 bg-white/10 rounded-lg">
                            <div className="h-3 w-20 bg-white/20 rounded mb-2"></div>
                            <div className="h-6 w-24 bg-green-400 rounded"></div>
                          </div>
                        </div>
                      </div>
                    )}
                    {activeFeature === 1 && (
                      <div className="space-y-4 animate-fade-in">
                        ...
                        <div className="pl-11">
                          <div className="h-2 w-full bg-green-400 rounded-full mb-2"></div>
                    ...
                    {activeFeature === 2 && (
                      <div className="space-y-4 animate-fade-in">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <div className="p-2 bg-white/10 rounded">Emergency Contacts</div>
                          <div className="p-2 bg-white/10 rounded">Allergies</div>
                        </div>
                      </div>
                    )}
                  </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="group p-6 bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            {[
              ...
              <div key={index} className="relative group">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-2xl blur-xl opacity-0 group-hover:opacity-20 transition-opacity"></div>
                <div className="relative bg-white p-8 rounded-2xl shadow-lg border border-gray-100 group-hover:border-blue-200 transition-all duration-300">
                  <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-xl flex items-center justify-center text-white text-2xl font-bold mb-6 group-hover:scale-110 transition-transform">
                    {item.step}
                  </div>
      ...
      <section id="testimonials" className="py-24 bg-gray-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Loved by
              <span className="text-blue-600"> Families Everywhere</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="relative flex overflow-x-hidden">
              <div className="animate-scroll flex space-x-8">
                {[...testimonials, ...testimonials].map((testimonial, index) => (
                  <div
                    key={index}
                    className="flex-shrink-0 w-80 bg-white rounded-2xl shadow-xl p-6 mx-4"
                  >
                    <div className="flex items-center mb-4">
                      <div className={`w-12 h-12 ${testimonial.color} rounded-xl flex items-center justify-center text-white font-bold text-lg`}>
                        {testimonial.avatar}
                      </div>
                      <div className="ml-4">
      ...
      <section className="py-24 bg-gradient-to-r from-blue-600 to-cyan-600 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-white rounded-full mix-blend-overlay filter blur-3xl opacity-20"></div>
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-white rounded-full mix-blend-overlay filter blur-3xl opacity-20"></div>
        </div>
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/signup"
              className="group px-8 py-4 bg-white text-blue-600 font-semibold rounded-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
            >
              <span className="flex items-center justify-center">
                Start Free Trial
                <svg className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="#features"
              className="px-8 py-4 bg-blue-500 text-white font-semibold rounded-xl border-2 border-white/30 hover:bg-blue-400 transform hover:scale-105 transition-all duration-300"
            >
              Learn More
            </a>
          </div>
